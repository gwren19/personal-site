            ...
            <div className="box">
                <article className="media">
                    ...
                    <figure className="image">
                        <img className='self-photo' src={require("./resources/IMG_8667.jpeg")} alt="Placeholder image" />
                    </figure>
                    </div>
                    ...
                    <div className="content">
                        ...
                        <p id='about-buttons' className='buttons'>
                                <a className="button is-info" href='https://drive.google.com/file/d/1Kh5crAxU7H0-mfEAtJo0PIazsxvoWOUq/view?usp=sharing' target='_blank'>
                                    <span class="icon">
                                    <i className='far fa-file-pdf'></i>
                                    </span>
                                    <span>My Resume</span>
                                </a>
                                <a className="button is-info" href='https://www.linkedin.com/in/gwren19' target='_blank'>
                                    <span class="icon">
